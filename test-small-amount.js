...
(async () => {
  console.log('🚀 소액 결제 플로우 테스트 시작 (1010원)...\n');
  ...
  try {
    ...
    console.log('2️⃣ 10,000원 상품 선택 (테스트용 최소 금액)...');
    ...
    await page.screenshot({ path: 'screenshots/small-amount-error.png', fullPage: true });
  } finally {
    await browser.close();
    console.log('✅ 테스트 완료');
  }
